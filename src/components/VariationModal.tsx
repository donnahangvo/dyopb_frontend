...
//   const VariationModal: React.FC<ProductComponentProps> = ({ productId }) => {
//     const { selectedVariation: contextSelectedVariation, setSelectedVariation } = useSpecification();
//     const [loading, setLoading] = useState<boolean>(true);
//     const [error, setError] = useState<string>('');
...
//         setSelectedVariation(variation);
//         setOpen(true);
//         setSelectedVariation(variation); // Update the selected variation in the context
//       };
