  ...
  useEffect(() => {
    const fetchOrderData = async () => {
      try {
        ...
        setOrderInfo({ ...response.data, shippingCost, totalPrice });
      } catch (error) {
            ...
            >
              <div>
                ...
                <Typography variant="body1">
                  {activeStep >= 2 ? orderInfo.totalPrice : ""}
                </Typography>
              </div>
              <InfoMobile totalPrice={activeStep >= 2 ? orderInfo.totalPrice : ""} />
            </CardContent>
          </Card>
          <Box
            sx={{
